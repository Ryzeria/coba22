...
export const loveUtils = {
  ...
  getRandomCompliment: () => {
    const compliments = [
      ...
      "Kamu itu amazing, tahu nggak? 💖",
      "Eyes mu sparkle kayak bintang 🌟",
      "Kamu perfect just the way you are 💕",
      "Your laugh is my favorite sound 😊",
      "Kamu bikin everything feels magical ✨"
    ];
...
export const achievementUtils = {
  ...
  generateAchievementMessage: (type, value) => {
    const messages = {
      level: `🎉 Selamat! Kamu sudah menyelesaikan ${value} level!`,
      score: `⭐ Amazing! Total score kamu ${value} points!`,
      time: `⏰ Wow! Kamu sudah menghabiskan ${value} menit di journey ini!`,
      streak: `🔥 Streak ${value} hari! Keep it up!`,
      perfect: `💯 Perfect score! Kamu memang luar biasa!`
    };
