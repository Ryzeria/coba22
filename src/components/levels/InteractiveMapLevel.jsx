...
const InteractiveMapLevel = ({ level, onComplete }) => {
  ...
  const personalizedLocations = [
    {
      name: "Papua - Tanah Kenangan Masa Kecil",
      coordinate: { lat: -4.269, lng: 138.080 },
      memory: "Tempat yang special banget buat kamu! Masa kecil yang indah waktu Pak Niam kerja di Sampoerna. Aku tau kamu kangen banget sama Papua, makanya someday kita harus kesana bareng. Aku pengen liat tempat yang bikin childhood kamu jadi memorable ✈️",
    ...
    },
    {
      ...
      memory: "Home sweet home! Tempat dimana bocah Tambran favoritku dibesarkan. Aku belum pernah kesana, tapi pengen banget suatu hari main ke rumah kamu, ketemu Pak Niam sama Bu Nita, dan liat lingkungan yang ngebentuk kamu jadi amazing kayak sekarang 🏘️",
      image: "/images/photos/special-place-1.jpg",
      date: "Hometown Visit (Soon!)",
      icon: "🏠"
    },
    {
      name: "SMAN 1 Magetan - Tempat Kamu Bersinar",
      coordinate: { lat: -7.650, lng: 111.350 },
      memory: "Sekolah dimana kamu jadi ketua Mahardika yang keren! Tempat kamu develop leadership skills, belajar biologi yang kamu suka, dan jadi remaja yang inspiring. Bangga banget sama semua achievement kamu di sekolah 🏫",
    ...
    },
    {
      ...
      memory: "Kampus dimana aku belajar sambil mikirin kamu terus. Dari sini aku kirim pesan-pesan manis, video call sama kamu, dan dreaming about our future together. Distance makes the heart grow fonder! 💙",
      image: "/images/photos/cute-moment-1.jpg",
      date: "College Life",
      icon: "🎓"
    },
    {
      ...
      memory: "Kampus impian kamu untuk jadi dokter gigi! Aku yakin banget kamu bakal diterima di sini. Nanti kalau kamu kuliah di Unair, kita bisa lebih deket dan date IRL lebih sering. Can't wait untuk support kamu achieve this dream! 🦷",
      image: "/images/photos/favorite-date.jpg",
      date: "Future Dream",
      icon: "🦷"
    }
  ];
      ...
      {visitedLocations.size === locations.length && visitedLocations.size > 0 && (
        ...
        >
          ...
          <p className="text-white/90 text-lg max-w-2xl mx-auto">
            Kamu udah explore semua tempat spesial dalam hidup kita! 
            Dari Papua masa kecil kamu, Tambran hometown, sampai future dreams kita di Surabaya. 
