...
const InteractiveStoryLevel = ({ level, onComplete }) => {
  ...
  const defaultStory = {
    start: {
      text: "Di hari ulang tahun ke-17 yang istimewa ini, kamu duduk di kamar sambil prepare untuk celebration. Tiba-tiba, phone kamu bunyi dengan notification dari Mas Za. Ada pesan: 'Happy birthday bocah Tambran favorit! Ada surprise special nih...' Apa yang akan kamu lakukan?",
      choices: [
    ...
    excited: {
      text: "Kamu langsung buka laptop dan akses website yang Mas Za kirim. WOW! Ternyata ada 17 level games yang specially made untuk ulang tahun ke-17 kamu! Setiap level berisi kenangan kalian dari roleplay era sampai sekarang. Mata kamu berbinar melihat effort yang Mas Za put into this.",
      choices: [
    ...
    call_first: {
      text: "Kamu video call Mas Za via Discord. Dia appear di screen dengan senyum lebar! 'Surprise!' katanya sambil waving. 'Aku udah prepare something special banget buat ulang tahun ke-17 kamu. It's a whole interactive website with games about us!'",
      choices: [
    ...
    social_media: {
      text: "Kamu post di IG story: 'Someone made me the most creative birthday surprise ever! 17 levels of love 💕 #BestBoyfriendEver #17thBirthday'. Responses langsung berdatangan dari teman-teman yang curious dan impressed!",
      choices: [
    ...
    start_gaming: {
      text: "Level 1 dimulai dengan timeline perjalanan kalian. Dari roleplay Shiro-Mochizuki, era study sessions, lost contact, sampai jadian 10 Maret 2023. Setiap memory ditampilkan dengan detail yang sweet banget. Kamu realize betapa Mas Za remember every little detail tentang relationship kalian.",
      choices: [
    ...
    screenshot: {
      text: "Kamu screenshot homepage website yang beautiful itu. The design is so aesthetic dengan warna pink dan purple yang kamu suka. Kamu save juga screenshot dari each level sebagai digital scrapbook. This is definitely going into your 'Special Memories' folder!",
      choices: [
    ...
    appreciation: {
      text: "Mas Za's face lights up! 'I spent weeks working on this, especially during semester break. Every level represents something special about you atau about us. Ada puzzle, games, memory lane, everything! Aku want your 17th birthday to be unforgettable.'",
      choices: [
    ...
    social_buzz: {
      text: "Teman-teman kamu pada comment 'Relationship goals banget!', 'Mas Za the best bf ever!', 'We need boyfriends like this!'. Kamu jadi proud banget dan reply dengan excited. Even ketua kelas Mahardika comment 'Wah kreatif banget pacarmu git!'",
      choices: [
    ...
    focus_surprise: {
      text: "Kamu decide untuk focus ke surprise dari Mas Za first before social media. You open the website dan immediately fall in love dengan the design. Every detail shows his thoughtfulness dan effort yang dia put untuk bikin birthday kamu special.",
      choices: [
        { text: "Start the journey with full attention", next: "focused_gaming" }
      ]
    },
    level_progress: {
      text: "Setelah beberapa level, kamu sampai di puzzle tentang favorite things kamu. Mulai dari musang bulan yang pengen dipelihara, anggrek bulan favorit, sampai nasi alpukat yang Mas Za anggap aneh. Everything is so accurate dan detailed, prove betapa dia pay attention to everything about you.",
      choices: [
    ...
    mid_game_chat: {
      text: "Kamu quick chat ke Mas Za: 'Za this is SO SWEET! I can't believe you remember every detail about us 🥺💕'. Dia reply instantly: 'Everything about you is worth remembering, birthday girl! Keep playing, there's more surprises ahead!'",
      choices: [
        { text: "Continue dengan hati yang touched", next: "touched_continue" }
      ]
    },
    delayed_start: {
      text: "After documenting everything, kamu finally start playing. Each level unfolds like a love letter dalam bentuk interactive games. You realize this isn't just a birthday gift - this is months of work, love, dan attention to detail.",
      choices: [
        { text: "Appreciate every moment of the journey", next: "slow_appreciation" }
      ]
    },
    send_screenshots: {
      text: "Kamu send screenshots ke Mas Za dengan caption 'BABY THIS IS AMAZING 😭💕 I'm crying happy tears rn'. Dia reply: 'Jangan nangis dong, ini baru permulaan! Enjoy every level ya sayang 🥰'",
      choices: [
        { text: "Start playing dengan excitement penuh", next: "excited_start" }
      ]
    },
    love_confession: {
      text: "Mata Mas Za jadi soft dan loving. 'I love you too, Anggita. You deserve all the best things in life, dan aku want to be part of making your days special. This website is just a small way to show how much you mean to me. Happy 17th birthday, my amazing girlfriend.'",
      choices: [
    ...
    teasing: {
      text: "Mas Za blushing: 'Jangan digini dong, aku masih newbie programmer! Tapi kalau untuk kamu, aku bisa belajar apapun. Next time mungkin aku bikin app khusus buat kita!'",
      choices: [
        { text: "Sweet banget! Start exploring the website", next: "sweet_start" }
      ]
    },
    touched: {
      text: "Kamu genuinely touched: 'You learned a whole new skill just for my birthday?' Mas Za nods: 'Seeing you happy is worth any effort. Plus now I have new skills untuk future surprises!'",
      choices: [
    ...
    ending1: {
      text: "Kamu spend the entire afternoon playing through all 17 levels. Each one is more creative dan sweet than the last. When you finally finish, you feel so loved dan appreciated. You immediately call Mas Za back: 'Za, this is the best birthday gift ever! Aku nggak akan pernah lupa ini. Thank you for loving me in such a beautiful way.' This birthday will forever be remembered as the day love was expressed through code dan creativity.",
      ending: true
    },
    emotional: {
    ...
    happy_gaming: {
      text: "Kamu continue gaming dengan hati yang full of joy. Setiap level brings new surprises, memories, dan inside jokes yang bikin kamu ketawa dan smile. By the time you reach level 17, you realize this has been the most perfect birthday celebration ever.",
      choices: [
        { text: "Complete all levels dengan happiness", next: "ending3" }
      ]
    },
    touched_continue: {
      text: "Dengan hati yang touched, kamu continue journey through every level. Each surprise makes you fall in love more dengan thoughtfulness Mas Za. This is definitely the most romantic gesture anyone has ever done for you.",
      choices: [
