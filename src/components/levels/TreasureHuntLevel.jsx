  ...
  const personalizedPhotos = [
    {
      ...
      clue: "Di masa study session kita, aku sering gambarin hewan apa buat kamu waktu ngajarin matematika?",
      answer: "bebek",
      hint: "Hewan yang lucu dan sering aku sketch sambil explain rumus-rumus"
    },
    {
    ...
    },
    {
      ...
      clue: "Hewan favorit yang pengen kamu pelihara tapi Pak Niam sama Bu Nita belum ngizinin?",
      answer: "musang bulan",
      hint: "Hewan nokturnal yang cute banget dan ada kata 'bulan' nya"
    },
    {
      image: "/images/photos/recent-photo.jpg",
      clue: "Makanan aneh yang kamu suka tapi bikin aku bingung?",
      answer: "nasi alpukat",
      hint: "Kombinasi weird antara carb dan buah hijau"
    },
    {
      image: "/images/photos/birthday-last-year.jpg",
      clue: "Cita-cita kamu yang bikin aku bangga dan support terus?",
      answer: "dokter gigi",
      ...
      {foundClues.length === 0 && (
        ...
        >
          ...
          <p className="text-white/80 mb-4">
            ...
            Setiap clue adalah tentang kenangan spesial kita atau hal-hal yang kamu suka!
          </p>
