...
const PersonalityQuizLevel = ({ level, onComplete }) => {
  ...
  const getScoreMessage = () => {
    ...
    if (percentage === 100) return "Perfect! Kamu mengenal dirimu dengan luar biasa! 🌟";
    if (percentage >= 80) return "Amazing! Kamu sangat tahu tentang dirimu sendiri! ✨";
    if (percentage >= 60) return "Great! Kamu punya self-awareness yang baik! 💖";
        ...
        >
          ...
          <div className="bg-white/10 backdrop-blur-sm p-6 rounded-2xl border border-white/20">
            ...
            <p className="text-white/80">
              Setiap jawaban menunjukkan betapa uniknya dirimu, dan aku semakin jatuh cinta dengan setiap aspek kepribadianmu! 💕
            </p>
          </div>
